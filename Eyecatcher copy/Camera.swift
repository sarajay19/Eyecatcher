...
class Camera: NSObject {
    ...
    private let normalCameraPosition = AVCaptureDevice.Position.back

    
    private var allCaptureDevices: [AVCaptureDevice] {
        AVCaptureDevice.DiscoverySession(deviceTypes: [.builtInTrueDepthCamera, .builtInDualCamera], mediaType: .video, position: .unspecified).devices
    }
...
//    }
    ...
    func takePhoto() {
        ...
        sessionQueue.async {
           ...
           // uiImage = UIImage(ciImage: detImage)
        }
    }
}
